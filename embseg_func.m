...
function segmentedImage = embryoSegmentation(inputImage, inputID)
    ...
    mean_emb_area = 68271;
    k = 0.07;
    lower_bound2 = mean_emb_area*(1-k);
    upper_bound2 = mean_emb_area*(1+k);

    area_range = [lower_bound2, upper_bound2];
...
embryoSegmentation(emb_im_ds,1) %use original image as needed